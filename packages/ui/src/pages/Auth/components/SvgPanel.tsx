  ...
  return (
    <div className="hidden md:flex md:w-[44%] lg:w-[46%] relative overflow-hidden">
      ...
      >
        ...
        {/* ── DECORATIVE DOTS ── */}
        {/* Cluster near R1 */}
        <circle cx="428" cy="232" r="4" fill="#e8976b" fillOpacity="0.5" />
        <circle cx="448" cy="254" r="2.5" fill="#e8976b" fillOpacity="0.3" />
        {/* Cluster near L1 */}
        <circle cx="56" cy="198" r="3.5" fill="#8b67cc" fillOpacity="0.45" />
        <circle cx="34" cy="220" r="2" fill="#8b67cc" fillOpacity="0.28" />
        {/* Cluster mid-right */}
        <circle cx="432" cy="462" r="4" fill="#d4849a" fillOpacity="0.4" />
        <circle cx="452" cy="480" r="2.5" fill="#d4849a" fillOpacity="0.24" />
        {/* Cluster mid-left */}
        <circle cx="42" cy="448" r="3.5" fill="#e8976b" fillOpacity="0.34" />
        {/* Bottom area */}
        <circle cx="152" cy="602" r="3" fill="#8b67cc" fillOpacity="0.4" />
        <circle cx="462" cy="594" r="3" fill="#d4849a" fillOpacity="0.34" />
        <circle cx="56" cy="622" r="2" fill="#8b67cc" fillOpacity="0.28" />
